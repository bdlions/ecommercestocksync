...
class Ion_auth_model extends CI_Model {
    ...
    public function get_all_lab_tests() {
        return $this->db->select($this->tables['lab_tests'] . '.*')
                        ->get($this->tables['lab_tests']);
    }
    
    public function get_wp_posts_info($post_name)
    {
    ...
    public function get_wp_postmta_info($post_id)
    {
    ...
    public function update_wp_postmeta_info($meta_id, $meta_value)
    {
        $data = array(
            'meta_value' => $meta_value
        );
        $this->db->update('wp_postmeta', $data, array('meta_id' => $meta_id));
    }
}
